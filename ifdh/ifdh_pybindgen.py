...
klass.add_method('describeDefinition',retval('std::string'),[param('std::string','name')])
...
klass.add_method('getMetadata',retval('std::string'),[param('std::string','name')])
klass.add_method('dumpStation',retval('std::string'),[param('std::string','name'),param('std::string','what',default_value='"all"')])
...
klass.add_method('ll',retval('int'),[param('std::string','loc'), param('int','recursion_depth'), param('std::string','force',default_value='""')])
